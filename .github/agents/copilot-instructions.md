...
- TypeScript 5.x (strict mode), Node.js 20+ + Next.js 15 (App Router), React 19, TanStack Table, shadcn/ui, Prisma ORM (016-admin-state-discovery)
- PostgreSQL via Prisma (`DiscoveryRun`, `UrlCandidate` tables — already exist) (016-admin-state-discovery)
- TypeScript (strict mode) on Node.js; Python 3.9+ for Scrapling CLI + Existing — `node:child_process` (spawn), Zod (validation), Cheerio + Turndown (standard fetcher). New — Scrapling Python package (external CLI, not a Node.js dep) (017-scrapling-fallback-fetcher)
- PostgreSQL with Prisma ORM (no schema changes for this feature) (017-scrapling-fallback-fetcher)
...
## Recent Changes
- 017-scrapling-fallback-fetcher: Added TypeScript (strict mode) on Node.js; Python 3.9+ for Scrapling CLI + Existing — `node:child_process` (spawn), Zod (validation), Cheerio + Turndown (standard fetcher). New — Scrapling Python package (external CLI, not a Node.js dep)
- 016-admin-state-discovery: Added TypeScript 5.x (strict mode), Node.js 20+ + Next.js 15 (App Router), React 19, TanStack Table, shadcn/ui, Prisma ORM
